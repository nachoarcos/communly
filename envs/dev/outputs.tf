...
output "api_gateway_endpoint" {
  description = "URL de invocacion de la API. En dev, usar directamente este valor como VITE_API_BASE_URL/*api si no se pasa por CloudFront."
...
output "lambda_execution_role_arn" {
  description = "Rol de ejecucion Lambda compartido efectivamente usado por todas las funciones de este entorno"
